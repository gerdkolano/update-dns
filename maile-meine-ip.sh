...
MESSAGE="Mit php von zoe.xeo an michalmolako@wp.pl gesendet. \
 ...
 § 1619 Das Kind ist, solange es dem elterlichen Hausstand angehört und von den Eltern erzogen oder unterhalten wird,\
  verpflichtet, in einer seinen Kräften und seiner Lebensstellung entsprechenden Weise\
